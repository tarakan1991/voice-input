...
| Вопрос | Решение |
|---|---|
| Режим активации | Toggle (нажал — говоришь — нажал/тишина) и удержание (push-to-talk: говоришь, пока держишь; отпустил — стоп) — переключается в настройках. Комбинация — обычная (клавиша + модификаторы); отпускание ловится штатным плагином, Input Monitoring не требуется. Отдельная клавиша Fn — не в v1 |
